#!/usr/bin/env python3
"""
GL RL Model Training Script for SageMaker (Fixed Version)
Includes dependency installation for SageMaker environment
"""
...
def install_packages():
    """Install required packages in SageMaker container"""
    packages = [
        'datasets>=2.14.0',
        'peft>=0.6.0',
        'accelerate>=0.24.0',
...
def load_training_data(data_path):
    ...
    if not jsonl_files:
        ...
        jsonl_files = list(Path(data_path).rglob("*.jsonl"))
    ...
    if not jsonl_files:
        ...
        sample_file = Path(data_path) / "sample_data.jsonl"
